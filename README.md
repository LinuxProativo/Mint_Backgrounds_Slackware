<p align="center">
  <img src="logo.png" alt="ALPack" width="512"/>
</p>
...
```bash
chmod +x install_mint_backgrounds
sudo ./install_mint_backgrounds
```

That’s it — the Mint wallpapers will be installed on your system.

## 📂 Where wallpapers are installed

Depending on your desktop environment, they are usually placed in locations such as:
